...
import { IReactiveCommand } from "./ireactive.command";


/**
 * Command object used to encapsulate information which is needed to perform an action.
 */
export class ReactiveCommand implements IReactiveCommand {
 ...
 */
export class ReactiveCommandAsync extends ReactiveCommand {
	constructor(
